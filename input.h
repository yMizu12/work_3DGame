...
/* game pad情報 */
// 左スティック★
#define STICK_UP_L		0x00000001l	// 方向キー上(.IY<0)
#define STICK_DOWN_L	0x00000002l	// 方向キー下(.IY>0)
#define STICK_LEFT_L	0x00000004l	// 方向キー左(.IX<0)
#define STICK_RIGHT_L	0x00000008l	// 方向キー右(.IX>0)

// 右スティック★
#define STICK_UP_R		0x00010000l	// 方向キー上(.IY<0)
#define STICK_DOWN_R	0x00020000l	// 方向キー下(.IY>0)
#define STICK_LEFT_R	0x00040000l	// 方向キー左(.IX<0)
#define STICK_RIGHT_R	0x00080000l	// 方向キー右(.IX>0)

// 十字キー★
#define BUTTON_UP		0x00100000l	// 十字キー上
#define BUTTON_DOWN		0x00200000l	// 十字キー下
#define BUTTON_LEFT		0x00400000l	// 十字キー左
#define BUTTON_RIGHT	0x00800000l	// 十字キー右
